...
public class ContactInformation extends TestBase {
  ...
  public void testContactInformation() throws Exception {
    ...
    app.getContactInformationHelper().fillContactInformation(new ContactData("1234567", "7654321", "test", "test1", "test2", "supirpuper"));
    app.getContactInformationHelper().flagUp("FRANCHISE_MAIL_EVENT0043AUCTION");
